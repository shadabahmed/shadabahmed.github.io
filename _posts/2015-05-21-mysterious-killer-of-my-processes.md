...
So next day, I figured out what other thing was happening at the same time. It turns out that another team was uploading a huge data which also involved lots of processing and thus system was becoming `OOM` (Out of Memory) and the `OOM Killer` was killing my processes. Looking at the mem stats:
